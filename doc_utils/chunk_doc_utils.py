...
class ChunkDocUtils(DocWriteUtils):
    ...
    def run_function_across_chunks(self, function: Callable, chunk_field, field: str=None, output_field: str=None, doc={}):
        ...
        self.set_field_across_documents(output_field, map(function, chunk_values), chunk_values)
    
    def run_function_across_chunks_across_docs(self, function: Callable, 
        chunk_field: str, field: str=None, output_field: str=None, docs=[]):
        """Run a function across chunk field in documents
        """
        def map_run_function_across_chunks(doc):
            return self.run_function_across_chunks(function, 
                chunk_field, field, output_field, doc)
